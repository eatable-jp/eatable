...
function LandingPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      setError(
        "Sorry, Failed to create an account. Have you already registered this email?"
      );
    }
  }
          ...
          <Col>
            <Card>
              <Card.Body>
                ...
                {success && (
                  <Alert variant="success">Registerd Successfully</Alert>
                )}
            ...
            <div className="w-100 text-center mt-2 lp-guide-text">
              ...
              <Link to="/login" className="lp-guide-link">
                Log In
              </Link>
            </div>
          </Col>
